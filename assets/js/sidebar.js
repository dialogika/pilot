...
const MENU_BY_ROLE = {
  owner: [
    { section: "Utama" },
    { id: "dashboard", label: "Home", href: "/home.html", icon: "bi-house" },
    { id: "my-tasks", label: "My Tasks", href: "/quest/my-tasks.html", icon: "bi-check2-square" },
    { id: "activity", label: "Activity", href: "/quest/activity.html", icon: "bi-clock-history" },
  ...
  intern: [
    ...
    { id: "daily-report", label: "Daily Report", href: "/quest/daily-report.html", icon: "bi-journal-text" },
  ],
  mentor: [
    { section: "Utama" },
    { id: "dashboard", label: "Home", href: "/home.html", icon: "bi-house" },
    { id: "schedule", label: "Jadwal Mengajar", href: "/quest/my-tasks.html", icon: "bi-calendar-week" },
